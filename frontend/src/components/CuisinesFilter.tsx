  ...
  return (
    <>
      ...
      <div className="space-y-2 flex flex-col">
        {cuisinesList.slice(0, isExpanded ? cuisinesList.length : 5).map((cuisine, index) => {
          ...
          return (
            <div key={index} className="flex">
              ...
              <Label
                ...
                className={`flex flex-1 items-center text-sm rounded-full px-4 py-2 font-semibold 
